...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="<c:url value="/list/list.do?method=getAll"/>">电商系统,卖家系统-商品管理</a>
        </div>
...
<div class="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        <fieldset style="width:700px;"><legend>修改物品</legend>
            ...
            <form name="articleform" class="form-horizontal" action="${pageContext.request.contextPath}/list/list.do?method=updateArticle"
                ...
                <table align="center">
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;<input type="button" onclick="window.location = 'list.do?method=getAll' ; " class="btn btn-danger btn-sm" data-dismiss="modal" value="返回" /></td>
                    </tr>
                </table>
            </form>
        </fieldset>
...
<script src="${pageContext.request.contextPath }/resources/js/taobao.js"></script>
 <script type="text/javascript">
    $(function(){
    	 var te= $("#addTypeCode").val("${article.articleType.code}");
      //alert(te); 
    });
